...
from .views import HomePageTeamsList, TeamInfo, FollowTeam, MyTeams, GetFranchiseLeaderData, GetNBAStandings
...
urlpatterns = [
    ...
    path('standings/', GetNBAStandings.as_view(), name='standings')
]
